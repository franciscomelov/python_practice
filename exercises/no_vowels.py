...
def del_vowels(text):
    ...
    for vowel in vowels:
        while vowel in text:
            text.pop(text.index(vowel))
    print("".join(text))
    # El codigo de arriba y abajo hace lo mismo
    final = [letter for letter in text if letter not in vowels ]
    print("".join(final))
    


if __name__ == "__main__":
    #text = input("Ingresa el texto a procesar: ")
